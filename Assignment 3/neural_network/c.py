...
if __name__ == "__main__":
    ...
    # List to store ALL predictions (to be appended in one column)
    all_predictions = []
    ...
    for hidden_arch in hidden_archs:
        ...
        nn = NeuralNetwork(
            ...
            activation=sigmoid,          # Can also try relu
            delActivation=delSigmoid,    # Can also try delRelu
            learningRate=0.01,
            batchSize=32,
            maxIterations=300,           # Max Number of epochs
            epi=1e-2,
            mse=True
        )
        ...
        # IMPORTANT: Append predictions to the list
        # Each model's predictions are added sequentially
